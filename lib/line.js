 ...
 * ตั้ง APP_BASE_URL (หรือ PUBLIC_URL) ไว้ใน environment variable
 * เพื่อให้ตรงกับ Callback URL ใน LINE เสมอ
 * (โดเมน preview ของ Vercel เปลี่ยนทุก deploy จึงห้ามอาศัย host จากคำขอในโหมด production)
 *
 * รับค่าที่เผลอใส่ path มาด้วยได้ เช่น https://example.com/api/auth/callback
 * จะถูกตัดเหลือเฉพาะโดเมน
 */
